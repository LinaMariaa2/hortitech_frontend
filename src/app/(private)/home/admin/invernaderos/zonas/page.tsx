...
export default function ZonasPage() {
  ...
  const handleFormSubmit = async () => {
    ...
    try {
      let res;
      if (editando) {
        res = await axios.put(`${process.env.NEXT_PUBLIC_API_URL}/api/zona/${editando.id_zona}`, payload);
        ...
        res = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/api/zona`, payload);
    ...
    setModalConfirm({
      ...
      onConfirm: async () => {
        try {
          ...
          await axios.patch(`${process.env.NEXT_PUBLIC_API_URL}/api/zona/${ruta}/${zona.id_zona}`);
  ...
  const eliminarZona = (zona: Zona) => {
    ...
    setModalConfirm({
      ...
      onConfirm: async () => {
        try {
          await axios.delete(`${process.env.NEXT_PUBLIC_API_URL}/api/zona/${zona.id_zona}`);
